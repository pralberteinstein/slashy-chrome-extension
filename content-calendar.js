if (!window.slashyCalendarPopupShown) {
  ...
  overlay.id = 'slashy-calendar-overlay';
  ...
  popup.innerHTML = `
    <div id="slashy-calendar-popup" style="
      position: fixed;
      top: 50%;
      left: 50%;
    ...
    ">
      ...
      <h3 style="
        ...
        line-height: 1.4;
      ">Did you mean to open Slashy Calendar?</h3>
      ...
      <div style="
        ...
        gap: 12px;
      ">
        <button id="yesCalendarButton" style="
        ...
        ">Yes</button>
        <button id="noCalendarButton" style="
          background: #f3f4f6;
          color: #4b5563;
  ...
  const yesBtn = popup.querySelector('#yesCalendarButton');
  const noBtn = popup.querySelector('#noCalendarButton');
  ...
  yesBtn.addEventListener('click', () => {
    window.location.href = "https://slashy.com/calendar";
  });
